...
class Correlation:
	...
	def classify(self, results):
		...
		# Now figure out the sensitivity and specificity
		for r in results:
			val = self.get_val(r)
...
set ytics nomirror
set yrange [0:5]
set ylabel "Odds Ratio"

set arrow from 0, {val} to 1, {val} heads filled lc "red"
set arrow from 4.07,0 rto graph 0,0.2 filled lc "red"
set label "SC2/RaTG13" at 4.07,0
...
""")
	...
	for f in ("total_sites", "total_singles", "OR"):
